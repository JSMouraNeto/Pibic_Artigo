...
if __name__ == '__main__':
    ...
    # **MODIFICAÇÃO: Tamanho de imagem padrão para ResNet**
    parser.add_argument('--image_size', type=int, default=224, help="Tamanho da imagem (ResNet usa 224x224)")
    # Dropout não é necessário na classe do modelo, pois o classificador é uma única camada linear
    ...
    if base_args.data_dir == 'caminho/para/seu/dataset' or not os.path.isdir(base_args.data_dir):
        ...
        results_base_dir = "training_results_resnet50"
